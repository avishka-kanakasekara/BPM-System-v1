...
import { allocationRequestPath } from '../navigation/recommendationNavigation';
...
export default function RecommendationLookupPage() {
  ...
  return <main className="min-h-screen bg-slate-50 px-4 py-8 text-slate-900"><div className="mx-auto max-w-5xl space-y-6"><header><p className="text-sm font-semibold uppercase tracking-wide text-indigo-600">Agent 3</p><h1 className="text-3xl font-bold">Recommendation lookup</h1><p className="mt-2 text-slate-500">Retrieve a tenant-scoped summary by recommendation or correlation ID.</p><Link className="mt-3 inline-block text-indigo-700 underline focus:ring-2 focus:ring-indigo-500" to={allocationRequestPath}>Create a new allocation request</Link></header>
