...
from app.agents.agent2_execution.main import app
...
def test_human_governance_gate():
    ...
    r_app = client.post(f"/api/v1/agent2/recommendations/{rec_id}/approve", json=decision)
    ...
    r_rej = client.post(f"/api/v1/agent2/recommendations/{rec_id}/reject", json=decision)
