...
def create_human_evidence(
    ...
    return HumanResourceEvidence(
        ...
        authority=authority,
        available_from=reference - timedelta(days=1),
        available_until=reference + timedelta(days=365),
        ...
        evidence_checked_at=reference - timedelta(days=evidence_age_days),
        evidence_valid_until=reference + timedelta(days=90),
        evidence_references={
            "source": "synthetic_fixture",
            "availability": {"verified_at": reference.isoformat()},
            "workload": {"verified_at": reference.isoformat()},
        },
    )
...
def create_budget_evidence(
    ...
    return BudgetResourceEvidence(
        ...
        valid_until=reference + timedelta(days=365),
...
def create_human_requirement(
    ...
    return HumanResourceRequirement(
        ...
        task_deadline=reference + timedelta(days=deadline_days),
