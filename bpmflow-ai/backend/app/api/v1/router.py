...
Aggregates Agent 4 process/approval/exception/audit/auth/policy routes, Agent 3
...
from app.agents.agent2_execution.routers.execute import router as agent2_execute_router
...
api_router.include_router(
    agent2_execute_router, dependencies=[Depends(get_current_user)]
)
